...
class TB_alert_Module extends Themify_Builder_Component_Module {
	...
	return array(
		...
		'binding' => array(
		    ...
		    'message' => array('show' => 'alert_message_text', 'hide' => array('action_btn_link_alert', 'open_link_new_tab_alert')),
		    'url' => array('show' => array('action_btn_link_alert', 'open_link_new_tab_alert'), 'hide' =>'alert_message_text')
		)
	    ),
	    array(
